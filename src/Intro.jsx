  ...
  return (
    <div className="main">
      <div className="container">
        <h1 className="intro">Welcome to SmartprepAI</h1>
        <p className="intro-para">
          Step into the world of SmartprepAI, where intelligent conversations and
          ...
          Let SmartprepAI redefine your digital encounters – your next experience
          is just a name away!
        </p>
